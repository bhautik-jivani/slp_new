        ...
        try:
            ...
            if request.method == 'POST':
                ...
                for i in range(int(batch_quantity)):
                    ...
                    data = QrCode.objects.create(product_id=product_id, batch_id=latest_batch_record.id,
...
def download_qr_code(request, id):
    ...
    for batch in batch_detail:
        qr_code_detail = QrCode.objects.filter(batch_id=id)
